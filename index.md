<content style="color:#4a4a4a; font-family:Helvetica Neue;">
  ...
  <br/>
  <br/>
  <h2 style="font-size:25px; font-weight:normal;">About me</h2>
<!--   <hr style="height:1px;border:none;color:#333;background-color:#333;" /> -->
  ...
  <h2 style="font-size:25px; font-weight:normal;">Education</h2>
    <p style="font-size:17px;">
  ...
  <h2 style="font-size:25px; font-weight:normal;">Projects</h2>
    <p style="font-size:17px;">
    </p>
  <br/>
  <br/>

  <h2 style="font-size:25px; font-weight:normal;">Awards and Honors</h2>
    <p style="font-size:17px;">
    </p>
  <br/>
  <br/>
